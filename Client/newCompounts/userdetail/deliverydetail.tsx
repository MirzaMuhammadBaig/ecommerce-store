      ...
      <div className="mt-10 sm:mt-0">
        <div className="md:grid ">
          ...
          <div className="mt-5 md:col-span-2 md:mt-0">
            <form action="#" method="POST" className="justify-center flex">
              <div className="overflow-hidden shadow sm:rounded-md">
                ...
                <div className="bg-gray-50 px-1 flex justify-center gap-5 py-3 text-right sm:px-6">
                  <button
                    type="submit"
                    className="inline-flex justify-center rounded-2xl border border-transparent bg-gray-300 py-2 px-4 text-lg font-medium  shadow-sm hover:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-300 focus:ring-offset-2"
                  >
                    Payment
                  </button>
                  <button
