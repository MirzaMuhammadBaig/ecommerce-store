  ...
  const submitForm = async (data: any) => {
    ...
    try {
      const response = await axios({
        method: "post",
        url: "https://ecommerce-store-rho.vercel.app/api/user/register",
        data: obj,
      });
  ...
  return (
    <>
      <div className="xl:px-20 md:px-10 sm:px-6 px-4 md:py-12 py-9 2xl:mx-auto 2xl:container md:flex items-center justify-center ">
        <div className="bg-slate-500 shadow-lg rounded-radius xl:w-1/2 lg:w-2/3 md:w-2/3 w-full lg:px-10 sm:px-6 sm:py-10 px-2 py-6">
          <p
            tabIndex={0}
            className="focus:outline-none text-2xl font-extrabold leading-6 text-primary"
          >
            Register your account
          </p>
          <form onSubmit={submitForm}>
            <div className="lg:flex justify-between md:flex-wrap md:block sm:block mt-6">
              <label
                htmlFor="email"
              ...
              <input
                ...
                type="text"
                className=" border rounded-radius text-xs font-medium leading-none placeholder-gray-800 text-secondary py-3 w-full pl-3 mt-2"
                placeholder="name"
                value={firstname}
                onChange={NAME}
              />
            ...
            <div className="mt-4 w-full">
              ...
              <input
                ...
                aria-labelledby="email"
                type="text"
                className=" border rounded-radius text-xs font-medium leading-none text-secondary py-3 w-full pl-3 mt-2"
                placeholder="name "
                value={lastname}
                onChange={LASTNAME}
              />
            ...
            <div className="mt-4 w-full">
              ...
              <p
                tabIndex={0}
                className="focus:outline-none text-sm mt-4 font-medium leading-none text-primary"
              >
                Have an account{" "}
                <Link
                  href="./Signin"
                  className="hover:text-blue-800 focus:text-blue-800 focus:outline-none focus:underline hover:underline text-sm font-medium leading-none text-blue-800 cursor-pointer"
                >
                  {" "}
                  Sign in here
                </Link>
            ...
            <div className="mt-8">
              <button
                role="button"
                type="submit"
                className="focus:ring-2 focus:ring-offset-0 focus:ring-indigo-700 text-sm font-semibold leading-none text-primary focus:outline-none bg-gray-200 rounded-radius py-4 w-full"
              >
                Create my account
              </button>
            </div>
          ...
          {/* <div className="w-full flex items-center justify-between py-5">
            <hr className="w-full " />
            <p className="text-base font-medium leading-4 px-2.5 text-primary">
              OR
            </p>
            <hr className="w-full" />
          </div> */}
          ...
          {/* <button
            ...
            role="button"
            className="focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 p-3 rounded-radius flex items-center w-full bg-primary hover:opacity-75"
          >
            <svg
              width={19}
              height={20}
        ...
        <div className="xl:w-1/3 md:w-1/2 lg:ml-16 ml-8 md:mt-0 mt-6 ">
          ...
          <div className="flex items-start mt-8">
            ...
            <p className="sm:text-2xl text-xl leading-7 text-primary pl-2.5">
          ...
          <div className="flex items-center pl-8 mt-10 ">
            ...
            <div className="ml-2">
              ...
              <p className="text-sm font-medium leading-none text-primary mt-1 cursor-pointer hover:underline">
                See profile
              </p>
            </div>
          </div>
